...
| Add a build / launch / package / sign / notarize / embed / lint / test / deploy / dev-loop task | `workflows/bb-over-shell` (bb.edn; never a new `.sh` or `.py`) |
...
700-799  Workflows       Git, PRs, releases
  ...
  725      Git Worktrees
  730      Datever
  740      Bb Over Shell (automation MUST be bb tasks; no .sh or .py scripts beyond a thin bb-invoking shim)
